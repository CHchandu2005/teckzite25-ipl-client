...
const CardContainer = styled.div`
  ...
  @media (max-width: 768px) {
    gap: 30px; /* Reduce gap on tablets */
  }

  @media (max-width: 480px) {
    gap: 15px; /* Reduce gap even more on mobile devices */
  }
`;
...
const Webteam = () => {
  return (
    <TeamsContainer>
      <Content>
        <h2 className=" md:hidden text-4xl font-bold text-center mb-8 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
          Meet Our Team
        </h2>
        <CardContainer>
...
{teamMembers.map((member, index) => (
  <div
    key={index}
    className="relative w-80 bg-transparent p-1 rounded-lg mb-8 overflow-hidden"
  >
    {/* Cyberpunk Border Effect */}
    <div className="absolute inset-0 border-2 border-cyan-500 rounded-lg animate-pulse"></div>
    <div className="absolute inset-0 border-2 border-purple-500 rounded-lg blur-sm opacity-75"></div>
    <div className="absolute inset-0 border-2 border-blue-500 rounded-lg blur-lg opacity-50"></div>

    <div className="relative z-10 p-6 text-center bg-gray-900 bg-opacity-50 rounded-lg shadow-lg">
      <div className="relative mx-auto w-48 h-48 mb-6 hover:-translate-y-2 transition-transform duration-300">
